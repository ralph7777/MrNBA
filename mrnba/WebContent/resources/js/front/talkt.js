...
$(function(){
	render();
	var content = "Welcome!<br/>This is Mr.NBA.<br/>So tell me,<br/>What is your favourite NBA team?";
	content += "<br/><br/>Enter [teams] to see all teams I know.";
	// Introduction
...
function send() {
	...
	$.ajax({
		url : $("#basePath").val() + "AutoReplyT.action",
		type : "POST",
		//return dataType
		dataType : "text",
		timeout : 10000,
