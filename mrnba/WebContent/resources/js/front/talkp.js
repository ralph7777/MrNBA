...
$(function(){
	render();
	var content = "Welcome!<br/>This is Mr.NBA.<br/>So tell me,<br/>Who is your favourite NBA player?";
	content += "<br/><br/>Enter [players] to see all players I know.";
	// Introduction
	appendDialog("talk_recordbox","Mr.NBA",content);
	render();
});

/**
 * Print out msg and system reply
 * @param content
 * @param basePath
 */
function send() {
	...
	$.ajax({
		url : $("#basePath").val() + "AutoReplyP.action",
		type : "POST",
		//return dataType
		dataType : "text",
		timeout : 10000,
		success : function (data) {
			...
			appendDialog("talk_recordbox","Mr.NBA",data);
			$("#content").val("");
			render(); //Manipulate the page plan
		},
		//pass-in data
...
/**
 * load the scroll pane and lay out the page
 */
function render() {
